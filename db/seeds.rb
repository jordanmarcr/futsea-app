...
# #   Character.create(name: 'Luke', movie: movies.first)
 ...
 l_one = Location.create(name: "Soccer Cage Brickell", street: "301 SW 8th St" , city: "Miami" , zipcode: "33130", state: "FL", url: "https://www.soccercagemiami.com", phone: "305-343-1757", neighborhood: "Brickell", lat: "25.7666", lon: "-80.1998", price: 900, description: "Test description for Soccer Cage Brickell", open: 16, close: 22,img: 'https://i.ibb.co/zm3XB8y/citymain.png' ,img2: 'https://i.ibb.co/DLC2csT/fieldnightlarge.png' ,img3: 'https://i.ibb.co/vk9yTYF/cliff.png')
 ...
 #Americas Got Soccer
 l_four = Location.create(name: "Americas Got Soccer", street: "3488 N Andrews Ave" , city: "Fort Lauderdale" , zipcode: "33309", state: "FL", url: "http://www.americasgotsoccer.com/", phone: "9549900611", neighborhood: "Oakland Park", lat: "26.1708", lon: "-80.1453", price: 1200, description: "Test description for Americas Got Soccer",open: 18, close: 21,img: 'https://i.ibb.co/QM2sg7Y/indoor.png',img2: 'https://i.ibb.co/64j8MjR/indoor2.png' ,img3: 'https://i.ibb.co/S6Kwrbn/stadiumfield.png' )
 ...
 l_eight = Location.create(name: "Holiday Park Soccer Fields", street: "1150 G. Harold Martin Dr" , city: "Fort Lauderdale" , zipcode: "33304", state: "FL", url: "https://www.fortlauderdale.gov/departments/parks-recreation/city-parks/holiday-park", phone: "9548285383", neighborhood: "Fort Lauderdale", lat: "26.1331", lon: "-80.1323", price: 800, description: "Test description for Holiday Park Soccer Fields",open: 17, close: 20,img: 'https://i.ibb.co/3NCMv1q/fieldnightlarge.png',img2: 'https://i.ibb.co/DLC2csT/fieldnightlarge2.png',img3: 'https://i.ibb.co/sKkH4CY/goalnight.png' )

 l_eightf_one = Field.create(game_type: 11,surface: "grass", outdoor: true, location: l_eight)

 #Urban Soccer Five
 l_nine = Location.create(name: "Urban Soccer Five", street: "1125 NW 71st St" , city: "Miami" , zipcode: "33304", state: "FL", url: "http://urbansoccerfive.com/", phone: "786253288", neighborhood: "Little Haiti", lat: "25.8397", lon: "-80.2156", price: 1100, description: "Test description for Urban Soccer Five",open: 15, close: 20, img:'https://i.ibb.co/64j8MjR/indoor2.png',img2:'https://i.ibb.co/zm3XB8y/citymain.png',img3:'https://i.ibb.co/vk9yTYF/cliff.png')
 ...
 Field.all.each do |field|
   field.location.open.upto(field.location.close).each do |time|
     0.upto(7).each do |day|
       Event.create(
         datetime: DateTime.new(2019, Date.today.strftime("%m").to_i, ((Date.today.strftime("%d").to_i+1)+day), time, 0, 0),
